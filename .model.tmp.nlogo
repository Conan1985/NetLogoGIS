...
Three buttons are placed in the interface tab. To use the model, first click the setup-map button to load the GIS information and draw the map. Clicking the  button runs the model. To completely reset the model space, select the setup button.
